...
func manageCameras() {
	...
	WHERE cameras.lastStreamed>unix_timestamp()-60 AND cameras.locked=1 AND cameras.room=outcam.room AND periods.stime<unix_timestamp()+60 AND periods.etime>unix_timestamp() )=0;`)
