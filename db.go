...
func createTables() {
	...
	db.Exec("CREATE TABLE recording ( sid CHAR(64) NOT NULL, id INT NOT NULL AUTO_INCREMENT, cid CHAR(64) NOT NULL, room VARCHAR(20) NOT NULL, time INT NOT NULL, status TINYINT NOT NULL, FOREIGN KEY(sid) REFERENCES schools(id), FOREIGN KEY(cid) REFERENCES classes(id), PRIMARY KEY(id) );")
}
