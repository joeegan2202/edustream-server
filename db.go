...
func createTables() {
	...
	db.Exec("CREATE TABLE roster ( sid CHAR(64) NOT NULL, pid CHAR(64) NOT NULL, cid CHAR(64) NOT NULL, PRIMARY KEY(sid,pid,cid), FOREIGN KEY (pid) REFERENCES people(id), FOREIGN KEY (cid) REFERENCES classes(id), FOREIGN KEY(sid) REFERENCES schools(id) );")
	...
	db.Exec("CREATE TABLE usage ( sid CHAR(64) NOT NULL, bytes BIGINT NOT NULL, PRIMARY KEY(sid), FOREIGN KEY (sid) REFERENCES schools(id) );")
	db.Exec("CREATE TABLE auth ( sid CHAR(64) NOT NULL, pid CHAR(64) NOT NULL, password CHAR(64) NOT NULL, PRIMARY KEY(pid,sid), FOREIGN KEY (sid) REFERENCES schools(id), FOREIGN KEY (pid) REFERENCES people(id) );")
	...
	db.Exec("CREATE TABLE recording ( sid CHAR(64) NOT NULL, id INT NOT NULL AUTO_INCREMENT, cid CHAR(64) NOT NULL, room VARCHAR(20) NOT NULL, period VARCHAR(10) NOT NULL, time INT NOT NULL, status TINYINT NOT NULL, FOREIGN KEY(sid) REFERENCES schools(id), FOREIGN KEY(cid) REFERENCES classes(id), PRIMARY KEY(id) );")
}
