...
func createTables(db *sql.DB) {
	...
	db.Exec("CREATE TABLE messages ( sid CHAR(64) NOT NULL, id INT NOT NULL AUTO_INCREMENT, room VARCHAR(20) NOT NULL, text TEXT NOT NULL, FOREIGN KEY (sid) REFERENCES schools(id), PRIMARY KEY (id) );")
}
